...
[1. **Genomic control** (Devlin & Roeder 1999)
   Divide all χ² by inflation factor λ — simple, but blunt]{style="color: #aaa"}

[2. **Infer latent sub-populations** (Pritchard et al. 2000)
   STRUCTURE / ADMIXTURE → run GWAS within each group and meta-analyze]{style="color: #aaa"}
...
[4. **Mixed effects modeling** (EMMAX, Kang et al. 2010)
   Kinship / GRM as random effect — gold standard, computationally intensive]{style="color: #aaa"}
