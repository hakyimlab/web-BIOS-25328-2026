...
Download the lab data from [Box](https://uchicago.box.com/s/snhot2x0272dzuuas4ipkgnrlxva2qga) and place it in a folder called `Lab-personal-genomes-project-data` inside your project directory. See [Lab 04](2026-04-17-lab-04/index.qmd) for full setup instructions.
:::
